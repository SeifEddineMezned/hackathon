from sqlalchemy import create_engine, Column, String, DateTime, Text, ForeignKey, JSON, event
...
class MemoryEvent(Base):
    ...
    source_type = Column(String(50))  # text, docs, images, audio
    ...
    embedding_ref = Column(String(50))
    ...
    graph_edges_to = relationship(
        "GraphEdge",
        foreign_keys="[GraphEdge.to_event_id]",
...
# WAL + busy_timeout + thread-safe access (critical for watcher + API together)
