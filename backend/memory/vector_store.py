...
class VectorStore:
    def __init__(self):
        ...
        self.mapping_path = f"{VECTOR_STORE_PATH}.pkl" # Int -> UUID map
        ...
        if os.path.exists(self.index_path) and os.path.exists(self.mapping_path):
            ...
            # Create HNSW index for fast approx search or simple FlatL2
    ...
    def add_event(self, event_uuid: str, vector: List[float]):
        ...
        with self.lock:
            ...
            self.id_map[self.next_id] = event_uuid
            self.next_id += 1
            self.save() # Auto-save on write for safety
